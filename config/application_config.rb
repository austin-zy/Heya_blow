configatron.configure_from_hash(
  ...
  :app_host => "heyablow.com", #override this in your application.yml
  :community_name => "Heya Community",

  :community_tagline => "Rock the night!",
  :community_description =>  "Heya Election Camp",
  :meta_description => 'Heya Election Camp',
  :meta_keywords => 'Heya',
